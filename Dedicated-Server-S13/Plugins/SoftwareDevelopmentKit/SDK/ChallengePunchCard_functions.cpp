...
void UChallengePunchCard_C::SetUpEncodedName(const class FString& Name_0, int32 Count)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// const struct FFortChallengePunchCardStyles&PunchStyle                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
void UChallengePunchCard_C::SetStyle(const struct FFortChallengePunchCardStyles& PunchStyle)
{
	...
	Parms.PunchStyle = std::move(PunchStyle);
