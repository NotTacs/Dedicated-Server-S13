...
public:
	...
	bool                                          K2Node_Event_bWasCancelled;                        // 0x000D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TArray<struct FActiveGameplayEffectHandle>    CallFunc_BP_ApplyGameplayEffectToTarget_ReturnValue; // 0x0188(0x0010)(ReferenceParm, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetPreviousVelocity_ReturnValue;          // 0x0198(0x000C)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                               CallFunc_GetDirectionActorToActor_ReturnValue;     // 0x01B4(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FVector                                CallFunc_GetForwardVector_ReturnValue;             // 0x01C4(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
