...
public:
	...
	struct FScalableFloat                         Row_TickInterval;                                  // 0x07C0(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                         Row_MaxHeals;                                      // 0x07E0(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
