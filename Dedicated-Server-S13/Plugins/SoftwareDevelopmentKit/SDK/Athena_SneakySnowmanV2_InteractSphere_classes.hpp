...
public:
	...
	class AAthena_Player_SneakySnowmanV2_C*       AssociatedSnowman;                                 // 0x07B8(0x0008)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
