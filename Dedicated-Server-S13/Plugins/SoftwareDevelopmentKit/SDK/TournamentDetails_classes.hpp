...
public:
	...
	TMulticastInlineDelegate<void()>              BackActionSelected;                                // 0x0820(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
