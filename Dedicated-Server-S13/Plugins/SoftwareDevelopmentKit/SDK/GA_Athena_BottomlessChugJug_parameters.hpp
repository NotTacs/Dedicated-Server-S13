...
struct GA_Athena_BottomlessChugJug_C_MakeCustomMontageInfo final
{
public:
	...
	TArray<struct FFortCharacterPartMontageInfo>  K2Node_MakeArray_Array;                            // 0x0018(0x0010)(ReferenceParm, HasGetValueTypeHash)
