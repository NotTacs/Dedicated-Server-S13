...
{
public:
	uint8                                         Pad_B08[0x20];                                     // 0x0B08(0x0020)(Fixing Size After Last Property [ Dumper-8 ])
	uint8                                         bAutoRegisterWithBudgetAllocator : 1;              // 0x0B28(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAutoCalculateSignificance : 1;                    // 0x0B28(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bShouldUseActorRenderedFlag : 1;                   // 0x0B28(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_B29[0x7];                                      // 0x0B29(0x0007)(Fixing Struct Size After Last Property [ Dumper-8 ])
