...
public:
	...
	TMulticastInlineDelegate<void()>              AboutToShowDetails;                                // 0x0D10(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
