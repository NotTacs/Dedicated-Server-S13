...
public:
	...
	UEType* GetInterfaceAddress()
	{
		static void* (*GetInterfaceAddressOriginal)(UObject*, UClass*) = decltype(GetInterfaceAddressOriginal)(InSDKUtils::GetImageBase() + 0x3359640);
		return (UEType*)GetInterfaceAddressOriginal(this, UEType::StaticClass());
	}
