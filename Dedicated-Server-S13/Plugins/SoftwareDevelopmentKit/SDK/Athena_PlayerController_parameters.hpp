...
public:
	...
	TDelegate<void(const class UAthenaMusicPackItemDefinition* NewMusicPack)> K2Node_CreateDelegate_OutputDelegate_4; // 0x02B4(0x0010)(ZeroConstructor, NoDestructor)
