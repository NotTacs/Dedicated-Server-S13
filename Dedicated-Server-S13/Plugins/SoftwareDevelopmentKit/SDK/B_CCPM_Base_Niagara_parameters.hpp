...
public:
	...
	TDelegate<void(float DeltaSeconds, const struct FVector& OldLocation, const struct FVector& OldVelocity)> K2Node_CreateDelegate_OutputDelegate_3; // 0x00F8(0x0010)(ZeroConstructor, NoDestructor)
	...
	bool                                          Temp_bool_Has_Been_Initd_Variable_1;               // 0x0224(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
