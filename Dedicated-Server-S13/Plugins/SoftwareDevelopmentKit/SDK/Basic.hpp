...
namespace Offsets
{
	constexpr int32 GObjects          = 0x089C1778;
	constexpr int32 AppendString      = 0x0315D2C0;
	constexpr int32 GNames            = 0x089A8A40;
	constexpr int32 GWorld            = 0x08AF5920;
	constexpr int32 ProcessEvent      = 0x0335FB80;
	constexpr int32 ProcessEventIdx   = 0x00000042;
    constexpr int32 Free              = 0x00000000;
    constexpr int32 Realloc           = 0x03071540;
}
