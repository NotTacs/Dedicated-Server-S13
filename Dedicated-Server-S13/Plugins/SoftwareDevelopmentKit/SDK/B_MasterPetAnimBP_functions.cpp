...
// Function B_MasterPetAnimBP.B_MasterPetAnimBP_C.PetLookAtOverrideLayer
// (HasOutParams, BlueprintCallable)
// Parameters:
...
void UB_MasterPetAnimBP_C::PetLookAtOverrideLayer(const struct FPoseLink& Pose, float LookAtOverrideInput_0, const struct FVector& LookAtTargetLocationInput_0, struct FPoseLink* PetLookAtOverrideLayer_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_MasterPetAnimBP_C", "PetLookAtOverrideLayer");

	Params::B_MasterPetAnimBP_C_PetLookAtOverrideLayer Parms{};
