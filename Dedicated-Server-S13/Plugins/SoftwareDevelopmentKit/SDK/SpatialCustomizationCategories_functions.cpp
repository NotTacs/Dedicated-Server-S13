...
// Parameters:
// bool                                    bCaptureMode                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void USpatialCustomizationCategories_C::OnSetCaptureMode(bool bCaptureMode)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SpatialCustomizationCategories_C", "OnSetCaptureMode");

	Params::SpatialCustomizationCategories_C_OnSetCaptureMode Parms{};

	Parms.bCaptureMode = bCaptureMode;
