...
// Parameters:
// bool                                    bUseSmallIcon                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void USpatialCustomizationChoice_C::UseSmallerIcon(bool bUseSmallIcon)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SpatialCustomizationChoice_C", "UseSmallerIcon");

	Params::SpatialCustomizationChoice_C_UseSmallerIcon Parms{};

	Parms.bUseSmallIcon = bUseSmallIcon;
