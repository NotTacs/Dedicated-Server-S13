...
public:
	...
	class UFortMediaSubtitlesPlayer*              SatelliteSubtitlesPlayer;                          // 0x02B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
