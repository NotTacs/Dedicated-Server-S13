...
void UGA_Athena_ZipLine_Smash_C::OnPawnEnterWater_Bind(class AFortPlayerPawn* FortPlayerPawn)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_ZipLine_Smash_C", "OnPawnEnterWater_Bind");

	Params::GA_Athena_ZipLine_Smash_C_OnPawnEnterWater_Bind Parms{};
