...
class S13_Choice_ToChoice_Low::USequenceDirector_C final : public ULevelSequenceDirector
{
public:
...
public:
	...
	static class S13_Choice_ToChoice_Low::USequenceDirector_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<S13_Choice_ToChoice_Low::USequenceDirector_C>();
	}
};
