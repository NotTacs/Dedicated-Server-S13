...
void ABP_Frontend_EventLevel_NavObject_MapTable_C::GetMinimapTextures(TSoftObjectPtr<class UTexture2D>* MinimapTexture, TSoftObjectPtr<class UTexture2D>* MinimapDiscoveryMask)
{
	static class UFunction* Func = nullptr;
