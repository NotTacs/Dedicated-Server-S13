...
{	
	...
	public:
		static void* Realloc(void* Ptr, uint64 Size, uint32 Alignment)
		{
            ...
            static void* (*FMemoryRealloc)(void* Ptr, uint64 Size, uint32 Alignment) = decltype(FMemoryRealloc)(uintptr_t(GetModuleHandle(0)) + 0x03071540); 		
	...
	public:
		...
		inline ArrayElementType* GetDataPtr() { return Data; }
